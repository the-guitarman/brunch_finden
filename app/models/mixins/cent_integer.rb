...
#        end
#
#        def cent_#{attribute_string}
#          read_attribute(:#{attribute_string})
#        end
#
#        def milli_#{attribute_string}
#          read_attribute(:#{attribute_string})
#        end
#      "
#
...
#
#        def #{attribute_string}_as_integer(val)
#          (val.to_f * 1#{'0'*decimal_place}).to_i
#        end
#        
#        def #{attribute_string}_as_float(val)
#          val.to_f / 1#{'0'*decimal_place}
#        end
#      "
#    end
#  end
